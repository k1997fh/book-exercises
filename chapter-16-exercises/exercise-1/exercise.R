...
ggplot(data = diamonds_sample) + geom_point(mapping = aes(x = carat, y = price, colour = "blue"))
...
ggplot(data = diamonds_sample) + geom_point(mapping = aes(x = carat, y = cut, size = cut))

# Try coloring the above plot based on the diamond's price!
ggplot(data = diamonds_sample) + geom_point(mapping = aes(x = carat, y = cut, size = cut, color = price))

# Draw a line plot (with line geometry) for `diamonds_sample`. The x-position 
# should be mapped to carat, y-position to price, and color to cut.
ggplot(data = diamonds_sample) + geom_line(mapping = aes(x = carat, y = price))
...
ggplot(data = diamonds_sample) + geom_point(mapping = aes(x = carat, y = price, alpha = 0.3)) + geom_smooth(mapping = aes(x = carat, y = price, fill = clarity))
